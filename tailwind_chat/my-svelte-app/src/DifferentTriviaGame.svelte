<script>
  ...
  async function generateQuestion() {
    ...
    try {
      const response = await axios.post('http://localhost:3000/api/different-question');
...
{#if $quizCompleted}
  <div class="flex fixed inset-0 z-[99] w-screen h-screen bg-white">
    <div class="relative top-0 bottom-0 right-0 flex-shrink-0 hidden w-1/3 overflow-hidden bg-cover lg:block">
      ...
      <img src="https://apod.nasa.gov/apod/image/2403/Seagull_Lacroce_1080.jpg" class="z-10 object-cover w-full h-full" alt="NASA starlight"/>
    </div>
